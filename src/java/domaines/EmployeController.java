...
public class EmployeController implements Serializable {
    ...
    List<Employe> employees = getFacade().findAll(); // Récupérer la liste complète des employés
    List<String> employeeNames = new ArrayList<>();

    for (Employe employee : employees) {
        // Ajouter les noms des employés à la liste
        employeeNames.add(employee.getNom()); // Supposons que le nom soit stocké dans une propriété "name"
    }
